...
return [
    ...
    | como as regras de tamanho. Sinta-se à vontade para ajustá-las conforme necessário.
    |
    */
    ...
    | atributos usando a convenção "attribute.rule". Isso ajuda a definir
    | mensagens específicas para uma determinada regra de atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas a seguir são usadas para substituir o espaço reservado dos
    | atributos por algo mais legível, como "Endereço de E-mail" em vez de "email".
    |
    */
